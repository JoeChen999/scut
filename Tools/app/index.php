<?php
    ...
    $platform = "";
    if (DeviceDetector::$isAndroidDevice){
        $platform = "android";
    } 
    else if (DeviceDetector::$isNewIOSDevice || DeviceDetector::$isiPad4Device){
        $platform = "ios";
    }
    $router = Router::get(array('appDirectory' => dirname(__FILE__).DIRECTORY_SEPARATOR.$platform.DIRECTORY_SEPARATOR));
    $apps = $router->app;
    

    $b = $router->baseURL . $platform . DIRECTORY_SEPARATOR;
    //DeviceDetector::detect();
            ...
            <?php if (DeviceDetector::$isAndroidDevice) { ?>
                ...
                ?>
                    ...
                    ?>
                        ...
                        <a class="button" href="<?php echo $b . $app[AppUpdater::INDEX_DIR] . '/genesis.apk'?>">Install Application</a>
