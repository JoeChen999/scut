...
<html>
    ...
    <body style="vertical-align:bottom; height:100%;background-color:#000000; background-image: url(../images/bg-2.gif); background-size:100%;background-repeat:no-repeat" class="<?php echo DeviceDetector::$category;?>>
        <div id="container" class="container">
		    ...
		    <div align="center">
                    	<span style="font-family:Arial;font-size:20px;font-weight:bold;color:#7a8f9f">Antinc App Installer</span>
                    </div>
		...
		<div><img src="../images/stylelines.png" height=100% width=100%/></div>
                ...
                ?>
                    ...
                    <?php } ?>
                        <a class="button" align="center" style="color:#89bae0;font-size:20px" href="itms-services://?action=download-manifest&amp;url=<?php echo $b . $app[AppUpdater::INDEX_DIR] . "/genesis.plist" ?>"><img align="left" src="../images/downloadicon.png" height="20px"/>&nbsp;&nbsp;Install Application</a>
            ...
            <?php } else if (DeviceDetector::$isiPad4Device) { ?>
                <div class='ipad-ios4'>
					...
					<div style="text-align:center;">
	                    <div>
	                    	<img src="images/kabam_logo.png" alt=""/>
	                    </div>
	                    <div style="margin-bottom:30px;">
	                    	<span style="font-size:20px;font-weight:bold;">SmokeBomb: Over-the-Air App Installer</span>
	                    </div>
					</div>
                    ...
                    <p class='hintdevice'>If your device does not have iOS 4.0 or later, please download the provisioning profile and the app on your computer from this page and install it <a href="<?php echo $b ?>itunes-installation.html">manually</a> via iTunes.
                    </p>

                    <p class='hintipad'>If an app install fails, install the profile and try again. Make sure your device has been approved by your team's Apple Developer Portal manager.</p>
			...
			if ($app[AppUpdater::INDEX_PLATFORM] != AppUpdater::APP_PLATFORM_IOS)
                ...
                ?>
                    ...
                    <div class="column span-6">
                        ...
                        <p><b>Version:</b>
                    <?php
                      if (isset($app[AppUpdater::INDEX_SUBTITLE])) {
                          echo $app[AppUpdater::INDEX_SUBTITLE] . " (" . $app[AppUpdater::INDEX_VERSION] . ")";
                      } else {
                          echo $app[AppUpdater::INDEX_VERSION];
                      }
                    ...
                    <?php if (isset($app[AppUpdater::INDEX_PROFILE])) { ?>
                            <a class="button" href="<?php echo $b . 'api/2/apps/' . $app[AppUpdater::INDEX_DIR] ?>?format=mobileprovision">Install Profile</a>
                    <?php } ?>
                            <a class="button" href="itms-services://?action=download-manifest&amp;url=<?php echo $b . $app[AppUpdater::INDEX_DIR] . "/genesis.plist" ?>">Install Application</a>
                        </div>
            ...
            <?php } else { ?>
                <div class='desktop'>
                    ...
                    <p class='hintdevice'><strong>iOS:</strong> If your device does not have iOS 4.0 or later, please download the provisioning profile and the app on your computer from this page and install it <a href="<?php echo $b ?>itunes-installation.html">manually</a> via iTunes.
                    </p>
