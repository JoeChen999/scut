...
{
    public class Action1100 : AuthorizeAction
    {
        private CLGetCommonShopInfo m_RequestPacket;
        private LCGetCommonShopInfo m_ResponsePacket;
        private int m_UserId;

        public Action1100(ActionGetter actionGetter)
            : base((short)1100, actionGetter)
        {
            m_RequestPacket = null;
            m_ResponsePacket = new LCGetCommonShopInfo();
            m_UserId = 0;
        }
        ...
        public override bool GetUrlElement()
        {
            ...
            m_RequestPacket = ProtoBufUtils.Deserialize<CLGetCommonShopInfo>((byte[])actionGetter.GetMessage());
            return true;
        }
