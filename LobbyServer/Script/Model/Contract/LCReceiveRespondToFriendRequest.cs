...
// Proto source: 3111_LCReceiveRespondToFriendRequest.proto
//----------------------------------------------------------------------------------------------------
...
{
    [Serializable, ProtoContract(Name = @"LCReceiveRespondToFriendRequest")]
    public partial class LCReceiveRespondToFriendRequest : PacketBase
    {
        public LCReceiveRespondToFriendRequest() { }

        public override PacketType PacketType { get { return PacketType.LobbyServerToClient; } }

        public override int PacketActionId { get { return 3111; } }
